...
void HHXOR::Decode(vector<int> from, vector<int> to, ECDAG *ecdag)
{
...
void HHXOR::DecodeSingle(vector<int> from, vector<int> to, ECDAG *ecdag)
{
...
void HHXOR::DecodeMultiple(vector<int> from, vector<int> to, ECDAG *ecdag)
{
    ...
    for (auto lost_node_syms : lost_node_syms_map)
    {
        ...
        { // for parity, calculate uncoupled code and group code
    ...
    for (auto lost_node_syms : lost_node_syms_map)
    {
        ...
        { // for parity, calculate uncoupled code
...
int HHXOR::GetNumSymbols()
{
    return _num_symbols;
}

void HHXOR::init_layout(int num_instances, int instance_id)
{

    // _num_symbols has already been initialized in HHXOR()
...
void HHXOR::SetLayout(vector<vector<int>> layout)
{
...
void HHXOR::SetSymbols(vector<int> symbols)
{
...
vector<int> HHXOR::GetRequiredSymbolsSingle(int failed_node)
{
...
vector<int> HHXOR::GetRequiredParitySymbolsSingle(int failed_node)
{
